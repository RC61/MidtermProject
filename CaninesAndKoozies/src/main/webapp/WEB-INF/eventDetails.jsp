		...
		<div class="row" id="details">
			<div class="col-md-6">
				<table>
					...
					<tr>
						<td><a href="searchVenueId.do?id=${event.venue.id}" target="_blank">${event.venue.name } </a></td>
					</tr>
					<tr>
						<td><h4>Event Date and Time:</h4></td>
					</tr>
					...
					<tr>
						<td><c:choose>
								<c:when test="${event.singleOnlyPreference == true }">
>>>>>>> 57f5c176d8b6ac6e82ec0c4d5f8569753e7c954b
						Yes
					</c:when>
								<c:otherwise>
						No
...
=======
					...
					<tr>
						<td><h4>Organized by:</h4></td>
					</tr>
					<tr>
						<td>${event.userCreated.username}</td>
					</tr>
					<tr>
			...
			<div class="col-md-6">
				...
				<c:choose>
					...
					<c:otherwise>
						<h4>
							<a href="home.do">Login</a> or <a href="register.do">Register</a>
							to add a comment.
						</h4>
					</c:otherwise>
				</c:choose>
