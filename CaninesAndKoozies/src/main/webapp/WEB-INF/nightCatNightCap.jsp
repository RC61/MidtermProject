...
<body>
	<p>
		<img src="https://i.imgur.com/Kyz0Jxf.png" class="lezlie" alt="lezlie"
			style="float: right; width: 370px; height: 460px;">
	</p>
	<p>
		<img src="https://i.imgur.com/Qroeewz.png" class="bubba" alt="bubba"
			style="float: left; width: 410px; height: 510px;">
	</p>
	<h1>
		Night Cat<br>Night Cap
	</h1>
